...
python tests/main.py --run_group RSD_small_exp --env minigrid_small --max_path_length 100 --seed 42 --traj_batch_size 64 --n_parallel 16 --n_epochs_per_eval 50 --n_epochs_per_save 25 --n_epochs_per_pt_save 25 --dim_option 4 --algo RSD --exp_name mini_4d_3P_img_dir_carry_original_C --phi_type Projection --policy_type Projection --sample_type Projection --explore_type SZN  --trans_optimization_epochs 100  --is_wandb 1  --SZN_w2 3 --SZN_w3 1 --SZN_window_size 5 --SZN_repeat_time 2 --n_epochs 301 --Repr_max_step 100 --dual_slack 5e-3 --dual_lam 1.0 --discrete 0

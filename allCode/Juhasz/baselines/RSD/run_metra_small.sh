...
python tests/main.py --run_group METRA_exp --env maze --max_path_length 100 --seed 0 --traj_batch_size 16 --n_parallel 2 --n_epochs_per_eval 5  --dim_option 4  --algo metra --exp_name MetraExp2 --phi_type baseline --explore_type SZN  --trans_optimization_epochs 50  --is_wandb 1  --SZN_w2 10 --SZN_w3 3 --SZN_window_size 10 --SZN_repeat_time 3  --n_epochs 10000 --Repr_max_step 300 --dual_slack 1e-3 

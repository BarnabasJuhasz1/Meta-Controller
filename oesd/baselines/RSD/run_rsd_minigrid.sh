...
# good, almost great!!
python tests/main.py --run_group RSD_exp --env minigrid_random_key --max_path_length 150 --seed 42 --traj_batch_size 128 --n_parallel 16 --n_epochs_per_eval 50 --n_epochs_per_save 25 --n_epochs_per_pt_save 25 --dim_option 8 --algo RSD --exp_name mini_8d_3P --phi_type Projection --policy_type Projection --sample_type Projection --explore_type SZN  --trans_optimization_epochs 100  --is_wandb 1  --SZN_w2 3 --SZN_w3 1 --SZN_window_size 5 --SZN_repeat_time 2 --n_epochs 501 --Repr_max_step 150 --dual_slack 5e-3 --dual_lam 1.0 --discrete 0

# try decreasing trajectory batch size ? they used 16
# python tests/main.py --run_group RSD_exp --env minigrid --max_path_length 150 --seed 42 --traj_batch_size 32 --n_parallel 4 --n_epochs_per_eval 50 --n_epochs_per_save 50 --n_epochs_per_pt_save 50 --dim_option 4 --algo RSD --exp_name mini_4d_1k_cont_obs_fixed_32_2 --phi_type Projection --explore_type SZN  --trans_optimization_epochs 100  --is_wandb 1  --SZN_w2 3 --SZN_w3 1 --SZN_window_size 5 --SZN_repeat_time 2 --n_epochs 1001 --Repr_max_step 150 --dual_slack 5e-3 --dual_lam 1.0 --discrete 0
